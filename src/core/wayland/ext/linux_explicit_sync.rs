...
impl Dispatch<ZwpLinuxExplicitSynchronizationV1, ()> for CompositorState {
    fn request(
        #[cfg_attr(not(feature = "desktop-protocols"), allow(unused_variables))]
        state: &mut Self,
        _client: &Client,
        ...
        match request {
            zwp_linux_explicit_synchronization_v1::Request::GetSynchronization {
                ...
                {
                    state.ext.linux_drm_syncobj.surface_sync_states.insert(sync_id, surface_id);
                }
    ...
    fn request(
        ...
        match request {
            ...
            zwp_linux_surface_synchronization_v1::Request::GetRelease { release } => {
                ...
                let _release_obj: zwp_linux_buffer_release_v1::ZwpLinuxBufferReleaseV1 = _data_init.init(release, ());
            }
